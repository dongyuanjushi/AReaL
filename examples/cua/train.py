...
try:  # Package-style relative import (works if executed via -m with package context)
    from .qwen3_agent import MultiTurnQwen3CUAgent  # type: ignore
...
class CUAWorkflow(RolloutWorkflow):
    def __init__(
        self,
        ...
        self.agent = MultiTurnQwen3CUAgent(
...
def get_cua_linux_rl_dataset(dataset_path, tokenizer):
